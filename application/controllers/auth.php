...
class Auth extends CI_Controller {
	...
	function create_user()
	{
		...
		$this->form_validation->set_rules('about', $this->lang->line('create_user_validation_about_label'), 'xss_clean');
	...
	function edit_user($id)
	{
		...
		$this->form_validation->set_rules('about', $this->lang->line('edit_user_validation_about_label'), 'xss_clean');
