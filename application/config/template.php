...
$config['title']['suffix'] = ' • Sauerfork';		// String will be added after every title
$config['title']['default'] = 'Sauerfork';					// Default title if no title is set; The only title not containing the prefix and suffix
